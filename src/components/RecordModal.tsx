...
import { X, Save, Trash2, Calendar, User, Stethoscope, MapPin, Tag, FileText } from 'lucide-react'
...
export function RecordModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-4 overflow-y-auto">
      <div className="bg-slate-900 border border-slate-800 w-full max-w-lg rounded-t-2xl sm:rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden text-slate-100 animate-in fade-in slide-in-from-bottom-4 duration-200">
        {/* Modal Header */}
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4 overflow-y-auto flex-1">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="col-span-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-slate-950 border border-slate-800 rounded-lg text-xs text-white focus:outline-none focus:border-teal-500"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">
              ...
              <select
                ...
                className="w-full px-2.5 py-2 bg-slate-950 border border-slate-800 rounded-lg text-xs text-white focus:outline-none focus:border-teal-500"
              >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 bg-slate-950 border border-slate-800 rounded-lg text-xs text-white focus:outline-none focus:border-teal-500 resize-none"
            />
          </div>
          ...
          <div className="pt-3 border-t border-slate-800 flex items-center justify-between gap-2">
            {record?._id && onDelete ? (
              <button
                ...
                disabled={isDeleting}
                className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-rose-500/10 text-rose-400 hover:bg-rose-500/20 text-xs font-medium transition-colors"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="submit"
                disabled={isSaving}
                className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-teal-500 hover:bg-teal-400 text-slate-950 font-bold text-xs transition-colors shadow-sm"
              >
